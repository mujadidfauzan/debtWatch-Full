  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <div className="bg-[#2a43d2] h-[50vh] flex flex-col items-center justify-center p-6 relative">
        ...
        <img src={illustrationPlaceholder} alt="Financial risk illustration" className="max-w-xs w-full object-contain" />
      </div>
      ...
      <div className="bg-white flex-grow rounded-t-[3rem] -mt-12 p-8 flex flex-col items-center text-center relative">
        <div className="flex-grow flex flex-col justify-center items-center">
          <h2 className="text-3xl font-bold text-gray-800 mb-4">Check Your Debt Risk</h2>
          <p className="text-gray-600 text-sm mb-8 max-w-xs">DebtWatch is an AI-powered app designed to help you detect potential debt traps early and take control of your financial future.</p>
        </div>
        ...
        {/* Next Button */}
        <Button className="bg-yellow-400 hover:bg-yellow-500 text-black rounded-full p-4 absolute bottom-8 right-8 shadow-lg" size="icon" onClick={handleNext}>
